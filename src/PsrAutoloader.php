...
class PsrAutoloader
{
     ...
     * @param int|null $pos   Start position for search into the class name
     *
     * @return bool
     */
    public function loadClass(string $class, int $pos = null): bool
    {
        ...
        $filename = \mb_substr($class, \mb_strlen($namespace) + 1);
